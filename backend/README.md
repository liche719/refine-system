...
该目录是 Refine System 的后端工作区。前端位于仓库同级的 [`../frontend`](../frontend)，全栈入口和统一启动命令见仓库根 [README](../README.md)。
...
java -jar refine-identity-service/target/refine-identity-service-1.0.0-SNAPSHOT.jar
java -jar refine-learning-service/target/refine-learning-service-1.0.0-SNAPSHOT.jar
java -jar refine-ai-service/target/refine-ai-service-1.0.0-SNAPSHOT.jar
java -jar refine-gateway/target/refine-gateway-1.0.0-SNAPSHOT.jar
```
